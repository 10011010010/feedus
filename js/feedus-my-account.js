 ...
 * 원본: WPCode snippet #367
 *
 * WooCommerce My Account 주소 페이지에서:
 * - 주소 표시 페이지: 인라인 편집 폼으로 교체 + 카카오 우편번호 검색
 * - 주소 편집 페이지: 카카오 우편번호 API 연동 + 전화번호 자동 포맷
 *
 * [중요] 카카오 우편번호 API는 WordPress 글로벌 헤더에서 별도로 로드:
